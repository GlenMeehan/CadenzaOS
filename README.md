...
* **edit <file> <text>:** One-shot file editor with auto-growth and block-aware append logic.
* **cat / rm / stat:** File reading, deletion, and metadata/latency inspection.
* **policy <mode>:** View or manually override the system operation mode (Admin, Dev, Gaming, AI).
...
* ✅ **Phase 5 (Part A):** Contextual Prioritization (Policy-to-Shell bridge).
* ✅ **Phase 5 (Part B):** Hybrid Terminal Rendering (Long-string stability).
